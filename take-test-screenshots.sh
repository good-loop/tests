...
SOURCE_JS=("$TESTS_HOME/compiled/rectangle-brand-funded.js" "$TESTS_HOME/compiled/rectangle-countdown.js" "$TESTS_HOME/compiled/rectangle-default.js" "$TESTS_HOME/compiled/testas-player.js")
